...
// const currentScorePlayer1 = document.getElementById("current--1").textContent;
const scorePlayer2 = document.querySelector("#score--2");
// const currentScorePlayer2 = document.getElementById("current--2");
...
hold.addEventListener("click", () => {
  if (playing) {
    ...
    // winner display
    if (scorePlayer[activePlayer - 1] >= 50) {
      playing = false;
      // finish the game
